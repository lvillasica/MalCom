...
admin = User.create(:email => 'admin@admin.com', :password => 'password', :password_confirmation => 'password', :admin => true, :status => 'Active')
admin.confirm!
#admin.readonly!

default_role = Role.create(:position => 'default',
